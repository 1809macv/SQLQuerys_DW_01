/****** Object:  View [PIVOT].[StockActual]    Script Date: 7/29/2019 6:00:02 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT Stock.CompanyId as IdDistribuidor
       ...
       ,Stock.Quantity as CantidadAlmacen ,round(1.0000/CUnit.Equivalence,2,0) as Valor1 
 ...
 WHERE Stock.Quantity <> 0 --and round(1/CUnit.Equivalence,2,1) <= Stock.Quantity
