...
WHILE (@DistribuidorId <= @MaxDistribuidorId)
	BEGIN
		INSERT INTO [PIVOT].[VentasXFecha]
		  (IdDistribuidor ,Distribuidor, NombreContacto ,AnioVenta ,MesVenta,Ciudad ,FechaVenta ,Zona ,ClienteTipo ,Categoria ,TipoRecursivo 
		  ...
		  ,FechaCreacionGuia ,FechaDespachoGuia
		  )
		 SELECT DistribuidorID ,Distribuidor ,NombreContacto ,Ciudad
			   ...
			   ,NumeroGuia, EstadoGuia, RepartidorNombre ,FechaCreacionGuia ,FechaDespachoGuia 
