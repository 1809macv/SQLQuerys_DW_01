TRUNCATE TABLE [PIVOT].[CoberturaXCliente];
...
SELECT IdDistribuidor, Distribuidor, Ciudad, AnioVenta, MesVenta, MesNumero, TipoNegocio, TipoCliente, CategoriaCliente, Zona, 
  ...
  FROM CoberturaXCliente 
 WHERE IdDistribuidor >= 3
GROUP BY IdDistribuidor, Distribuidor, Ciudad, AnioVenta, MesVenta, MesNumero, TipoNegocio, TipoCliente, CategoriaCliente, Zona